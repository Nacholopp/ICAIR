...
public class PanelPrincipal extends JPanel{
    ...
    JPanel pnlCambiarDatosBancarios;
    ...
    JButton btnCerrarSesion_PantallaOpciones, btnConsultarBilletesComprados_PantallaOpciones, btnSuscribirse_PantallaOpciones, btnCancelarSuscripcion_PantallaOpciones, btnAñadirDatosBancarios_PantallaOpciones, btnComprarBilletes_PantallaOpciones,
            btnDarseDeBaja_PantallaOpciones, btnCambiarBorrarDatosBancarios_PantallaOpciones;
    ...
    //endregion
    //ELEMENTOS PANTALLA DE BORRAR/CAMBIAR DATOS BANCARIOS
    //region
    private JButton btnVolverOpciones_PantallaDatosBancarios2, btnAñadirDatosBancarios_PantallaDatosBancarios2, btnBorrarDatosBancarios_PantallaDatosBancarios2;
    private JLabel lblNombreUsuarioIniciado_PantallaDatosBancarios2, lblNumeroTarjeta_PantallaDatosBancarios2, lblFechaCaducidad_PantallaDatosBancarios2, lblCVC_PantallaDatosBancarios2;
    private JLabel lblDatosBancariosRegistradosConExito2;
    private JTextField txtNumeroTarjeta_PantallaDatosBancarios2, txtFechaCaducidad_PantallaDatosBancarios2, txtCVC_PantallaDatosBancarios2;
    private Date fechaCaducidadtarjeta_PantallaDatosBancarios2;
    //endregion
    ...
    public PanelPrincipal(){
        ...
        */
        ...
        btnCambiarBorrarDatosBancarios_PantallaOpciones =new JButton("Cambiar datos bancarios");
        btnCambiarBorrarDatosBancarios_PantallaOpciones.setBackground(Color.WHITE);
        btnCambiarBorrarDatosBancarios_PantallaOpciones.setFont(new Font("Arial",Font.BOLD,30));
        btnCambiarBorrarDatosBancarios_PantallaOpciones.setBounds(25*tamOrig, 19*tamOrig, 25*tamOrig, 5*tamOrig);
        btnCambiarBorrarDatosBancarios_PantallaOpciones.addActionListener(new eventoBotonesPanelOpcionesSesionIniciada());
        pnlOpcionesSesionIniciada.add(btnCambiarBorrarDatosBancarios_PantallaOpciones);
        btnCambiarBorrarDatosBancarios_PantallaOpciones.setVisible(false);
        ...
        btnDarseDeBaja_PantallaOpciones =new JButton("Darse de baja");
        btnDarseDeBaja_PantallaOpciones.setBackground(Color.WHITE);
        btnDarseDeBaja_PantallaOpciones.setFont(new Font("Arial",Font.BOLD,30));
        btnDarseDeBaja_PantallaOpciones.setBounds(25*tamOrig, 31*tamOrig, 25*tamOrig, 5*tamOrig);
        btnDarseDeBaja_PantallaOpciones.addActionListener(new eventoBotonesPanelOpcionesSesionIniciada());
        pnlOpcionesSesionIniciada.add(btnDarseDeBaja_PantallaOpciones);
        ...
        lblIngresarDatosBancarios_PantallaOpciones.setBounds(12*tamOrig, 40*tamOrig, 80*tamOrig, 3*tamOrig);
        ...
        btnAñadirDatosBancarios_PantallaDatosBancarios =new JButton("Añadir datos bancarios");
        ...
        //PANTALLA PARA CAMBIAR O BORRAR DATOS BANCARIOS
        //region
        pnlCambiarDatosBancarios=new JPanel();
        pnlCambiarDatosBancarios.setBackground(Color.white);
        pnlCambiarDatosBancarios.setPreferredSize(d1);
        pnlCambiarDatosBancarios.setLayout(null);

        ImageIcon imageIconAñadirDatosBancarios2 = null;
        try {
            imageIconAñadirDatosBancarios2 = new ImageIcon(ImageIO.read(new File("C:\\ICAIR\\Imagenes\\Logo3.jpeg")));
        } catch (IOException e) {
            e.printStackTrace();
        }
        JLabel lblLogoAñadirDatosBancarios2 = new JLabel(imageIconAñadirDatosBancarios2);
        lblLogoAñadirDatosBancarios2.setBounds(tamOrig, tamOrig, 13*tamOrig, 4*tamOrig);
        pnlCambiarDatosBancarios.add(lblLogoAñadirDatosBancarios2);

        LinePanel linePanel13 = new LinePanel();
        linePanel13.setBounds(tamOrig, 6*tamOrig, ancho, 1);
        pnlCambiarDatosBancarios.add(linePanel13);

        lblNumeroTarjeta_PantallaDatosBancarios2 =new JLabel("Numero de Tarjeta (XXXX-XXXX-XXXX-XXXX):");
        lblNumeroTarjeta_PantallaDatosBancarios2.setFont(new Font("Arial",Font.BOLD,30));
        lblNumeroTarjeta_PantallaDatosBancarios2.setBounds(3*tamOrig, 6*tamOrig, 45*tamOrig, 3*tamOrig);
        pnlCambiarDatosBancarios.add(lblNumeroTarjeta_PantallaDatosBancarios2);

        txtNumeroTarjeta_PantallaDatosBancarios2 =new JTextField();
        txtNumeroTarjeta_PantallaDatosBancarios2.setFont(new Font("Arial",Font.BOLD,30));
        txtNumeroTarjeta_PantallaDatosBancarios2.setBounds(3*tamOrig, 9*tamOrig, 30*tamOrig, 3*tamOrig);
        pnlCambiarDatosBancarios.add(txtNumeroTarjeta_PantallaDatosBancarios2);

        lblFechaCaducidad_PantallaDatosBancarios2 =new JLabel("Fecha Caducidad (MM/AAAA):");
        lblFechaCaducidad_PantallaDatosBancarios2.setFont(new Font("Arial",Font.BOLD,30));
        lblFechaCaducidad_PantallaDatosBancarios2.setBounds(3*tamOrig, 12*tamOrig, 45*tamOrig, 3*tamOrig);
        pnlCambiarDatosBancarios.add(lblFechaCaducidad_PantallaDatosBancarios2);

        txtFechaCaducidad_PantallaDatosBancarios2 =new JTextField();
        txtFechaCaducidad_PantallaDatosBancarios2.setFont(new Font("Arial",Font.BOLD,30));
        txtFechaCaducidad_PantallaDatosBancarios2.setBounds(3*tamOrig, 15*tamOrig, 30*tamOrig, 3*tamOrig);
        pnlCambiarDatosBancarios.add(txtFechaCaducidad_PantallaDatosBancarios2);

        lblCVC_PantallaDatosBancarios2 =new JLabel("CVC (XXX):");
        lblCVC_PantallaDatosBancarios2.setFont(new Font("Arial",Font.BOLD,30));
        lblCVC_PantallaDatosBancarios2.setBounds(3*tamOrig, 18*tamOrig, 30*tamOrig, 3*tamOrig);
        pnlCambiarDatosBancarios.add(lblCVC_PantallaDatosBancarios2);

        txtCVC_PantallaDatosBancarios2 =new JTextField();
        txtCVC_PantallaDatosBancarios2.setFont(new Font("Arial",Font.BOLD,30));
        txtCVC_PantallaDatosBancarios2.setBounds(3*tamOrig, 21*tamOrig, 30*tamOrig, 3*tamOrig);
        pnlCambiarDatosBancarios.add(txtCVC_PantallaDatosBancarios2);

        btnAñadirDatosBancarios_PantallaDatosBancarios2 =new JButton("Añadir datos bancarios");
        btnAñadirDatosBancarios_PantallaDatosBancarios2.setBackground(Color.WHITE);
        btnAñadirDatosBancarios_PantallaDatosBancarios2.setFont(new Font("Arial",Font.BOLD,30));
        btnAñadirDatosBancarios_PantallaDatosBancarios2.setBounds(3*tamOrig, 26*tamOrig, 30*tamOrig, 4*tamOrig);
        btnAñadirDatosBancarios_PantallaDatosBancarios2.addActionListener(new eventoBotonesPanelAñadirDatosBancarios2());
        pnlCambiarDatosBancarios.add(btnAñadirDatosBancarios_PantallaDatosBancarios2);

        btnBorrarDatosBancarios_PantallaDatosBancarios2 =new JButton("Borrar datos bancarios");
        btnBorrarDatosBancarios_PantallaDatosBancarios2.setBackground(Color.WHITE);
        btnBorrarDatosBancarios_PantallaDatosBancarios2.setFont(new Font("Arial",Font.BOLD,30));
        btnBorrarDatosBancarios_PantallaDatosBancarios2.setBounds(42*tamOrig, 26*tamOrig, 30*tamOrig, 4*tamOrig);
        btnBorrarDatosBancarios_PantallaDatosBancarios2.addActionListener(new eventoBotonesPanelAñadirDatosBancarios2());
        pnlCambiarDatosBancarios.add(btnBorrarDatosBancarios_PantallaDatosBancarios2);

        btnVolverOpciones_PantallaDatosBancarios2 =new JButton("Volver");
        btnVolverOpciones_PantallaDatosBancarios2.setBackground(Color.WHITE);
        btnVolverOpciones_PantallaDatosBancarios2.setFont(new Font("Arial",Font.BOLD,30));
        btnVolverOpciones_PantallaDatosBancarios2.setBounds(ancho-200, tamOrig, 11*tamOrig, 4*tamOrig);
        btnVolverOpciones_PantallaDatosBancarios2.addActionListener(new eventoBotonesPanelAñadirDatosBancarios2());
        pnlCambiarDatosBancarios.add(btnVolverOpciones_PantallaDatosBancarios2);

        lblDatosBancariosRegistradosConExito2=new JLabel("Datos Bancarios Registrados con éxito");
        lblDatosBancariosRegistradosConExito2.setForeground(Color.RED);
        lblDatosBancariosRegistradosConExito2.setFont(new Font("Arial",Font.BOLD,30));
        lblDatosBancariosRegistradosConExito2.setBounds(3*tamOrig, 31*tamOrig, 50*tamOrig, 3*tamOrig);
        pnlCambiarDatosBancarios.add(lblDatosBancariosRegistradosConExito2);
        lblDatosBancariosRegistradosConExito2.setVisible(false);

        lblNombreUsuarioIniciado_PantallaDatosBancarios2 =new JLabel();
        lblNombreUsuarioIniciado_PantallaDatosBancarios2.setFont(new Font("Arial",Font.BOLD,30));
        lblNombreUsuarioIniciado_PantallaDatosBancarios2.setBounds(ancho-950, tamOrig, 25*tamOrig, 4*tamOrig);
        pnlCambiarDatosBancarios.add(lblNombreUsuarioIniciado_PantallaDatosBancarios2);

        this.add(pnlCambiarDatosBancarios);
        //endregion
        pnlCambiarDatosBancarios.setVisible(false);
            ...
            if(e.getSource()== btnRegistrarse_PantallaRegistro) {
                ...
                */
                if(lblNombre_PantallaRegistro.getForeground()==Color.BLACK && lblApellido1_PantallaRegistro.getForeground()==Color.BLACK && lblApellido2_PantallaRegistro.getForeground()==Color.BLACK && lblFechaNacimiento_PantallaRegistro.getForeground()==Color.BLACK &&
                    ...
                    txtContraseña2_PantallaRegistro.setText("");
                    */
                    User usuario = new User(Nombre, Apellido1, Apellido2, FechaNacimiento_String, Nacionalidad, CorreoElectronico, Contraseña1,0);
                    usuario.setPremium(false);
                    Visitor pointsVisitor = new PointsVisitor(50, 10);
                    usuario.accept(pointsVisitor);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getSource()== btnIniciarSesion_PantallaInicioSesion){
                ...
                if(mensajeLogin==true){
                    ...
                    else if(usuarioIniciado.getPremium()==true){
                    ...
                    if(usuarioIniciado.getNumerotarjeta()==null && usuarioIniciado.getFechacaducidadtarjeta() == null && usuarioIniciado.getCvc() == null){
                        btnCambiarBorrarDatosBancarios_PantallaOpciones.setVisible(false);
                        btnAñadirDatosBancarios_PantallaOpciones.setVisible(true);
                    }
                    else if(usuarioIniciado.getNumerotarjeta()!=null && usuarioIniciado.getFechacaducidadtarjeta() != null && usuarioIniciado.getCvc() != null){
                        btnCambiarBorrarDatosBancarios_PantallaOpciones.setVisible(true);
                        btnAñadirDatosBancarios_PantallaOpciones.setVisible(false);
                    }
    ...
    private class eventoBotonesPanelOpcionesSesionIniciada implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == btnCambiarBorrarDatosBancarios_PantallaOpciones){
                pnlOpcionesSesionIniciada.setVisible(false);
                pnlCambiarDatosBancarios.setVisible(true);
                lblIngresarDatosBancarios_PantallaOpciones.setVisible(false);
            }
            ...
            if(e.getSource()==btnDarseDeBaja_PantallaOpciones){
                lblIngresarDatosBancarios_PantallaOpciones.setVisible(false);
                Client cliente = new Client();
                String contexto = "/deleteUser";
                User usuarioAEliminar=new User(usuarioIniciado.getCorreoelectronico(), usuarioIniciado.getContrasena(), false);
                boolean userDeleted = cliente.sendMessage_User(contexto, usuarioAEliminar);
                pnlOpcionesSesionIniciada.setVisible(false);
                pnlPantallaInicial.setVisible(true);
            }
        }
    ...
    private class eventoBotonesPanelAñadirDatosBancarios2 implements ActionListener{
        @Override
        public void actionPerformed(ActionEvent e) {
            String numeroTarjeta= txtNumeroTarjeta_PantallaDatosBancarios.getText().trim();
            String fechaCaducidadTarjeta= txtFechaCaducidad_PantallaDatosBancarios.getText().trim();
            String cvc=txtCVC_PantallaDatosBancarios.getText().trim();
            if (e.getSource() == btnVolverOpciones_PantallaDatosBancarios2) {
                pnlAñadirDatosBancarios.setVisible(false);
                pnlOpcionesSesionIniciada.setVisible(true);
                lblDatosBancariosRegistradosConExito.setVisible(false);
                txtNumeroTarjeta_PantallaDatosBancarios.setText("");
            ...
            if (e.getSource() == btnAñadirDatosBancarios_PantallaDatosBancarios2){
                String NumeroTarjeta= txtNumeroTarjeta_PantallaDatosBancarios.getText().trim();
                String FechaCaducidad= txtFechaCaducidad_PantallaDatosBancarios.getText().trim();
                String CVC= txtCVC_PantallaDatosBancarios.getText().trim();
                if (NumeroTarjeta.length()==19) {
            ...
            if(e.getSource() == btnBorrarDatosBancarios_PantallaDatosBancarios2){
                String contexto =  "/setDatosbancarios";
                Client cliente_iniciado = new Client();
                Integer cvc_usuarioTarjeta=Integer.parseInt(cvc);
                User usuarioTarjeta=new User(usuarioIniciado.getCorreoelectronico(), usuarioIniciado.getContrasena(), null, null,null);
                boolean datosActualizados = cliente_iniciado.sendMessage_User(contexto,usuarioTarjeta);
                String context1 = "/getLoggedUser";
                usuarioIniciado = cliente_iniciado.buscarUsuarioIniciado(context1, usuarioTarjeta);
                txtNumeroTarjeta_PantallaDatosBancarios.setText("");
