...
public class User implements Serializable {
    ...
    public User(String nombre, String apellido1, String apellido2, String fechanacimiento, String nacionalidad, String correoelectronico, String contrasena, Integer puntos) {
        this.nombre = nombre;
        this.apellido1 = apellido1;
        this.apellido2 = apellido2;
        this.fechanacimiento = fechanacimiento;
